...
- Redis (optional, for session storage - currently using in-memory sessions)

### Installation

1. Clone the repository:
```bash
git clone https://github.com/christianberko/Dominoes.git
cd Dominoes/game
```
...
The app should be running at `http://localhost:5173` and the backend at `http://localhost:3000`.
